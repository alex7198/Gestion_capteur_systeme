...
DATA_SCRIPTS/./InitEntete.sh -id $idCapteur -ma Xiaomi -mo Aqara -u "Degré Celsius" -m "Température" -i $intervalle -la 51.0236 -lo 4.025
...
while :
  do
    ...
    echo $idCapteur $(echo "scale=1;$4/5" | bc -l) > SENSOR/$idCapteur/"$idCapteur"_TEMP.txt
