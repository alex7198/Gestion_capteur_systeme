...
DATA_SCRIPTS/./InitEntete.sh -id $idCapteur -ma Xiaomi -mo Aqara -u "Degré Celsius" -m "Température" -i $intervalle -la 64.256 -lo \-23.658
...
while :
  do
    ...
    echo $idCapteur $(echo "scale=1;$4/$4+$4/12" | bc -l) > SENSOR/$idCapteur/"$idCapteur"_TEMP.txt
