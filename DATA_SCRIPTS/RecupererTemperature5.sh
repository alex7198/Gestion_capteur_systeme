...
DATA_SCRIPTS/./InitEntete.sh -id $idCapteur -ma Xiaomi -mo Aqara -u "Degré Celsius" -m "Température" -i $intervalle -la 30.5698 -lo 32.5624
...
while :
  do
    ...
    echo $idCapteur $(echo "scale=1;$4/2-3" | bc -l) > SENSOR/$idCapteur/"$idCapteur"_TEMP.txt
