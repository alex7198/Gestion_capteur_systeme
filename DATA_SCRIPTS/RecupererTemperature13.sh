...
DATA_SCRIPTS/./InitEntete.sh -id $idCapteur -ma Xiaomi -mo Aqara -u "Degré Celsius" -m "Température" -i $intervalle -la 57.269 -lo 4.236
...
while :
  do
    ...
    echo $idCapteur $(echo "scale=1;$4/3-7" | bc -l) > SENSOR/$idCapteur/"$idCapteur"_TEMP.txt
