...
DATA_SCRIPTS/./InitEntete.sh -id $idCapteur -ma Xiaomi -mo Aqara -u "Degré Celsius" -m "Température" -i $intervalle -la \-18.698 -lo \-150.1561
...
while :
  do
    ...
    echo $idCapteur $(echo "scale=1;$4/2" | bc -l) > SENSOR/$idCapteur/"$idCapteur"_TEMP.txt
