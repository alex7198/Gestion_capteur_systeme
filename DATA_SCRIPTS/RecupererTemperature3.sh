...
DATA_SCRIPTS/./InitEntete.sh -id $idCapteur -ma Xiaomi -mo Aqara -u "Degré Celsius" -m "Température" -i $intervalle -la 40.3541 -lo 116.9654
...
while :
  do
    ...
    echo $idCapteur $(echo "scale=1;$4/5+1" | bc -l) > SENSOR/$idCapteur/"$idCapteur"_TEMP.txt
