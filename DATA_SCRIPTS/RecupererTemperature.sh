...
DATA_SCRIPTS/./InitEntete.sh -id $idCapteur -ma Xiaomi -mo Aqara -u "Degré Celsius" -m "Température" -i $intervalle -la 25.0258 -lo 47.014782
...
while :
  do
    ...
    echo $idCapteur $(echo "scale=1;$4-20" | bc -l) > SENSOR/$idCapteur/"$idCapteur"_TEMP.txt
