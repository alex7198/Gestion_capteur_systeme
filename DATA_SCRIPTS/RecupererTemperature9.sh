...
DATA_SCRIPTS/./InitEntete.sh -id $idCapteur -ma Xiaomi -mo Aqara -u "Degré Celsius" -m "Température" -i $intervalle -la 70.0147 -lo \-40.0896
...
while :
  do
    ...
    echo $idCapteur $(echo "scale=1;$4/$4-$4/20" | bc -l) > SENSOR/$idCapteur/"$idCapteur"_TEMP.txt
