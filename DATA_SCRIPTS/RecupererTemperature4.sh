...
DATA_SCRIPTS/./InitEntete.sh -id $idCapteur -ma Xiaomi -mo Aqara -u "Degré Celsius" -m "Température" -i $intervalle -la 40.965 -lo 127.142
...
while :
  do
    ...
    echo $idCapteur $(echo "scale=1;$4/5-2" | bc -l) > SENSOR/$idCapteur/"$idCapteur"_TEMP.txt
