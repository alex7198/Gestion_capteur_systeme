...
DATA_SCRIPTS/./InitEntete.sh -id $idCapteur -ma Campbell Scientific -mo CS215 -u "%" -m "HumiditéRelativeDeLaire" -la 42.59222 -lo 42.014782 -i $intervalle
...
while :
  do
    ...
    echo $idCapteur $(echo "scale=1;$pourceCPU +10" | bc -l) > SENSOR/$idCapteur/"$idCapteur"_TEMP.txt
