...
DATA_SCRIPTS/./InitEntete.sh -id $idCapteur -ma Xiaomi -mo Aqara -u "Degré Celsius" -m "Température" -i $intervalle -la 47.258 -lo 105.236
...
while :
  do
    ...
    echo $idCapteur $(echo "scale=1;$4/$4-$4/10" | bc -l) > SENSOR/$idCapteur/"$idCapteur"_TEMP.txt
