...
DATA_SCRIPTS/./InitEntete.sh -id $idCapteur -ma Xiaomi -mo Aqara -u "Degré Celsius" -m "Température" -i $intervalle -la 24.6589 -lo 54.2698
...
while :
  do
    ...
    echo $idCapteur $(echo "scale=1;$4-18" | bc -l) > SENSOR/$idCapteur/"$idCapteur"_TEMP.txt
